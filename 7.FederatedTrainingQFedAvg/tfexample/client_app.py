...
from tfexample.task import load_data_crossdevice, load_model, clarke_error_grid, zone_percentages_new
...
class FlowerClient(NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        # Desnormalizar los valores antes de calcular las zonas de Clarke
        ...
        # Calcular las zonas de Clarke con los valores desnormalizados
        ...
        # Ahora retornamos los valores necesarios
...
def client_fn(context: Context):
    ...
    X_train, X_test, y_train, y_test, archivo, scaler = load_data_crossdevice(partition_id)
